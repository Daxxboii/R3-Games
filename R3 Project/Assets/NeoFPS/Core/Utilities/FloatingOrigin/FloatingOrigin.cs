...
namespace NeoFPS
{
    ...
    public class FloatingOrigin : MonoBehaviour, INeoSerializableComponent
    {
        ...
        public static event UnityAction<FloatingOrigin> onFloatingOriginSystemChanged;
        ...
        private void Awake()
        {
            ...
            {
                system = this;
                onFloatingOriginSystemChanged?.Invoke(this);
            }
        }
        ...
        private void OnDestroy()
        {
            ...
            {
                system = null;
                onFloatingOriginSystemChanged?.Invoke(null);
            }
        }
